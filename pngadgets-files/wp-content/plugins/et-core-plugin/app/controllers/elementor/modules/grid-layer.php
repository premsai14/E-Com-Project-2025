...
class Grid_Layer {
	...
	public static function register_controls( $element ) {
		$element->start_controls_section(
			...
			[
				'label' => sprintf(__( '%s Grid Layer', 'xstore-core' ), apply_filters('etheme_theme_label', 'XSTORE')),
		...
		$element->add_control(
			'etheme_grid',
			[
				'label'     => sprintf(__( 'Enable %s Grid Layer', 'xstore-core' ), apply_filters('etheme_theme_label', 'XStore')),
