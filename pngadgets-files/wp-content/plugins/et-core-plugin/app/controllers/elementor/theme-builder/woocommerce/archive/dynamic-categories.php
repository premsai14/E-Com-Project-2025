...
class Dynamic_Categories extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return [ 'e-swiper', 'etheme-elementor-dynamic-product-categories' ];
    }
...
//		);
    ...
    public function generate_category_url_class($page_url, $category) {
        $category_class = '';
        if ( !$page_url || !apply_filters('etheme_dynamic_categories_support_ajax_filters', true) || !get_theme_mod('ajax_categories', 1) || is_tax('dc_vendor_shop') || (function_exists('wcfm_is_store_page') && wcfm_is_store_page()) || ( function_exists('wcfmmp_is_stores_list_page') && wcfmmp_is_stores_list_page()) ) {
