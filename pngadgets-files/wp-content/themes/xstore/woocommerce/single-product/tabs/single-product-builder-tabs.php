		...
		<div class="tabs wc-tabs<?php echo esc_attr( $element_options['ul_classes'] ); ?>" role="tablist">
			<?php foreach ( $product_tabs as $key => $product_tab ) : if ( !isset($product_tab['title'])) continue; ?>
				<div class="<?php echo esc_attr( $key ); ?>_tab et-woocommerce-tab" id="tab-title-<?php echo esc_attr( $key ); ?>" role="tab" aria-controls="tab-<?php echo esc_attr( $key ); ?>">
					<a href="#tab-<?php echo esc_attr( $key ); ?>" role="tab" aria-controls="tab-<?php echo esc_attr( $key ); ?>"><?php echo '' . $element_options['product_tabs_title_arrow']; ?><?php echo wp_kses_post( apply_filters( 'woocommerce_product_' . $key . '_tab_title', $product_tab['title'], $key ) ); ?></a>
				</div>
